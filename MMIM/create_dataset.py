            ...
            for segment in dataset[label_field].keys():
                ...
                for i, word in enumerate(_words):
                    if word[0] != b'sp':
                        ...
                        vlen.append(len(_visual[i, :]))
                        alen.append(len(_acoustic[i, :]))
                ...
                if vid in train_split:
                    train.append(((words, visual, acoustic, actual_words, vlen, alen), label, segment))
                elif vid in dev_split:
                    dev.append(((words, visual, acoustic, actual_words, vlen, alen), label, segment))
                elif vid in test_split:
                    test.append(((words, visual, acoustic, actual_words, vlen, alen), label, segment))
                else:
