...
# Modality
parser.add_argument('--modality', type=str, default='t',
                    help='type of the modality')
...
if __name__ == '__main__':
    ...
    test_loss_l = train_unimodal.initiate(hyp_params, train_loader, valid_loader, test_loader)
